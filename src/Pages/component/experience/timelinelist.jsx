...
const TimelineList = [
  ...
  },
  {
    ...
    discription:
      "Over the past year, I transitioned from a design background to a Front-end Engineering intern. Combining my design expertise with guidance from the company and self-directed learning in front-end programming, I actively participated in web development projects from a front-end engineer's perspective. During the internship, I played a pivotal role in assisting the development of the company's website.",
  ...
  },
  {
    ...
    company: "National Cheng Kung University",
    position:
      "Bachelor in Industrial Design and minor in Mechanical Engineering",
  },
  {
    category: "activity",
    year: "2021",
    ...
    discription:
      "During my university years, I participated in an internal selection process and had the opportunity to engage in a one-semester exchange program at Ewha Womans University in South Korea. Ewha Womans University is ranked 348th in the QS World University Rankings and 45th in the Asian University Rankings.",
  ...
  },
  {
    ...
    discription:
      "Selected for entrepreneurship based on the design product Unicharm Single-arm Hair Tie Holder, I represented the National Cheng Kung University entrepreneurial team in undergoing innovative entrepreneurship training at the renowned Plug and Play accelerator in Silicon Valley, USA.",
  ...
  },
  {
    ...
    discription:
      "I engaged in designing local cultural and creative products for Luoyang, collaborating with local intangible cultural heritage craftsmen. The focus was on integrating the distinctive historical and cultural features of the region into the design of cultural and creative products.",
